...
switch (uErrorCode)
    ...
    case PROTOCOL_STATUS_DEVICE_BAD_COMMAND
        szErrorMessage = '[Endpoint] The device received a message at endpoint 0 that could not be understood.';
...
fprintf('%s Error Code 0x%s\n', szErrorMessage, dec2hex(uErrorCode));
